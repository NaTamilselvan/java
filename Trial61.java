...
but one thing is noted if you a method in child class overwritten a perent class method only subtitude only unchecked exceptions not checked exception subtitude
...
public void fun2() throws exception{//Its error
